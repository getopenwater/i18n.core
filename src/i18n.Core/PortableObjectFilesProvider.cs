...
namespace i18n.Core
{
    public class PortableObjectFilesProvider : ILocalizationFilesProvider
    {
        ...
        public PortableObjectFilesProvider(IOptions<I18NLocalizationOptions> i18NLocalizationOptions)
        {
        ...
        {
            var assembly = Assembly.LoadFile(_i18NLocalizationOptions.CommonLocaleResource);
        ...
        {
            return File.OpenRead(Path.Combine(_i18NLocalizationOptions.LocaleDirectory, languageTag, "messages.po"));
        }
    }
}
